...
public class HackerManager : MonoBehaviour
{
	...
	public void DOSAttackBlocked()
	{
		...
		this.DOSAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.DOSAttackBlockedAniDone));
		this.DOSAniSeq.Insert(0f, DOTween.To(() => this.DOSAttackBlockedObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.DOSAttackBlockedObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.75f).SetEase(Ease.OutCubic));
		this.DOSAniSeq.Insert(0f, DOTween.To(() => this.DOSAttackBlockedObject.transform.localScale, delegate(Vector3 x)
		{
			this.DOSAttackBlockedObject.transform.localScale = x;
		}, new Vector3(1f, 1f, 1f), 0.75f).SetEase(Ease.OutCubic));
		this.DOSAniSeq.Insert(0f, DOTween.To(() => this.DOSPrompt1.fillAmount, delegate(float x)
		{
			this.DOSPrompt1.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(0f, DOTween.To(() => this.DOSPrompt2.fillAmount, delegate(float x)
		{
			this.DOSPrompt2.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(0f, DOTween.To(() => this.DOSPrompt3.fillAmount, delegate(float x)
		{
			this.DOSPrompt3.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX.Contrast, delegate(float x)
		{
			this.brightFX.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX.Gamma, delegate(float x)
		{
			this.brightFX.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX2.Contrast, delegate(float x)
		{
			this.brightFX2.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX2.Gamma, delegate(float x)
		{
			this.brightFX2.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Play<Sequence>();
	}

	public void DOSAttackPassed()
	{
		int num = UnityEngine.Random.Range(1, this.daysToLooseMax);
		...
		this.DOSAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.DOSAttackBlockedAniDone));
		this.DOSAniSeq.Insert(0f, DOTween.To(() => this.DOSAttackHackedObject.transform.localScale, delegate(Vector3 x)
		{
		...
		this.DOSAniSeq.Insert(0.75f, DOTween.To(() => this.DOSAttackHackedLostObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.DOSAttackHackedLostObject.GetComponent<CanvasGroup>().alpha = x;
		}, 1f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(3.75f, DOTween.To(() => this.DOSAttackHackedLostObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.DOSAttackHackedLostObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(3.75f, DOTween.To(() => this.DOSAttackHackedObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.DOSAttackHackedObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX.Contrast, delegate(float x)
		{
			this.brightFX.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX.Gamma, delegate(float x)
		{
			this.brightFX.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX2.Contrast, delegate(float x)
		{
			this.brightFX2.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX2.Gamma, delegate(float x)
		{
			this.brightFX2.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.DOSAniSeq.Play<Sequence>();
	...
	public void KAttackBlocked()
	{
		...
		this.brightFX.enabled = true;
		this.brightFX2.enabled = true;
		this.KAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.KAttackAniDone));
		this.KAniSeq.Insert(0f, DOTween.To(() => this.KAttackBlockedObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.KAttackBlockedObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.75f).SetEase(Ease.OutCubic));
		this.KAniSeq.Insert(0f, DOTween.To(() => this.KAttackBlockedObject.transform.localScale, delegate(Vector3 x)
		{
			this.KAttackBlockedObject.transform.localScale = x;
		}, new Vector3(1f, 1f, 1f), 0.75f).SetEase(Ease.OutCubic));
		this.KAniSeq.Insert(0f, DOTween.To(() => this.KPrompt1.fillAmount, delegate(float x)
		{
			this.KPrompt1.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(0f, DOTween.To(() => this.KPrompt2.fillAmount, delegate(float x)
		{
			this.KPrompt2.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(0f, DOTween.To(() => this.KPrompt3.fillAmount, delegate(float x)
		{
			this.KPrompt3.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX.Contrast, delegate(float x)
		{
			this.brightFX.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX.Gamma, delegate(float x)
		{
			this.brightFX.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX2.Contrast, delegate(float x)
		{
			this.brightFX2.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX2.Gamma, delegate(float x)
		{
			this.brightFX2.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
	...
	public void KAttackPassed()
	{
		...
		this.KAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.KAttackAniDone));
		this.KAniSeq.Insert(0f, DOTween.To(() => this.KAttackHackedObject.transform.localScale, delegate(Vector3 x)
		{
		...
		this.KAniSeq.Insert(0.75f, DOTween.To(() => this.KAttackHackedLostObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.KAttackHackedLostObject.GetComponent<CanvasGroup>().alpha = x;
		}, 1f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(3.75f, DOTween.To(() => this.KAttackHackedLostObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.KAttackHackedLostObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(3.75f, DOTween.To(() => this.KAttackHackedObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.KAttackHackedObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX.Contrast, delegate(float x)
		{
			this.brightFX.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX.Gamma, delegate(float x)
		{
			this.brightFX.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX2.Contrast, delegate(float x)
		{
			this.brightFX2.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX2.Gamma, delegate(float x)
		{
			this.brightFX2.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.KAniSeq.Play<Sequence>();
	...
	public void VAttackBlocked()
	{
		...
		this.brightFX.enabled = true;
		this.brightFX2.enabled = true;
		this.VAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.VAttackAniDone));
		this.VAniSeq.Insert(0f, DOTween.To(() => this.VAttackBlockedObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.VAttackBlockedObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.75f).SetEase(Ease.OutCubic));
		this.VAniSeq.Insert(0f, DOTween.To(() => this.VAttackBlockedObject.transform.localScale, delegate(Vector3 x)
		{
			this.VAttackBlockedObject.transform.localScale = x;
		}, new Vector3(1f, 1f, 1f), 0.75f).SetEase(Ease.OutCubic));
		this.VAniSeq.Insert(0f, DOTween.To(() => this.VPrompt1.fillAmount, delegate(float x)
		{
			this.VPrompt1.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(0f, DOTween.To(() => this.VPrompt2.fillAmount, delegate(float x)
		{
			this.VPrompt2.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(0f, DOTween.To(() => this.VPrompt3.fillAmount, delegate(float x)
		{
			this.VPrompt3.fillAmount = x;
		}, 0f, 0.75f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX.Contrast, delegate(float x)
		{
			this.brightFX.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX.Gamma, delegate(float x)
		{
			this.brightFX.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX2.Contrast, delegate(float x)
		{
			this.brightFX2.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(0.75f, DOTween.To(() => this.brightFX2.Gamma, delegate(float x)
		{
			this.brightFX2.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Play<Sequence>();
	}
	...
	public void VAttackedPassed()
	{
		...
		this.VAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.VAttackAniDone));
		this.VAniSeq.Insert(0f, DOTween.To(() => this.VAttackHackedObject.transform.localScale, delegate(Vector3 x)
		{
		...
		this.VAniSeq.Insert(0.75f, DOTween.To(() => this.VAttackHackedLostObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.VAttackHackedLostObject.GetComponent<CanvasGroup>().alpha = x;
		}, 1f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(3.75f, DOTween.To(() => this.VAttackHackedLostObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.VAttackHackedLostObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(3.75f, DOTween.To(() => this.VAttackHackedObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.VAttackHackedObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX.Contrast, delegate(float x)
		{
			this.brightFX.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX.Gamma, delegate(float x)
		{
			this.brightFX.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX2.Contrast, delegate(float x)
		{
			this.brightFX2.Contrast = x;
		}, -100f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(3.95f, DOTween.To(() => this.brightFX2.Gamma, delegate(float x)
		{
			this.brightFX2.Gamma = x;
		}, 9.9f, 0.5f).SetEase(Ease.Linear));
		this.VAniSeq.Play<Sequence>();
	...
	public void ConnectToRedRoom()
	{
		...
		this.hackingAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.startRedRoomLoading));
		this.hackingAniSeq.Insert(0.5f, DOTween.To(() => this.glitchFX.SettingsInterferences.Speed, delegate(float x)
		{
			this.glitchFX.SettingsInterferences.Speed = x;
		}, 6f, 2f).SetEase(Ease.OutSine));
		this.hackingAniSeq.Insert(0.5f, DOTween.To(() => this.glitchFX.SettingsTearing.Speed, delegate(float x)
		{
			this.glitchFX.SettingsTearing.Speed = x;
		}, 5f, 1.5f).SetEase(Ease.OutSine));
		this.hackingAniSeq.Insert(0.5f, DOTween.To(() => this.glitchFX.SettingsTearing.Intensity, delegate(float x)
		{
			this.glitchFX.SettingsTearing.Intensity = x;
		}, 0.5f, 1f).SetEase(Ease.OutSine));
		this.hackingAniSeq.Insert(0.5f, DOTween.To(() => this.glitchFX2.SettingsInterferences.Speed, delegate(float x)
		{
			this.glitchFX2.SettingsInterferences.Speed = x;
		}, 6f, 2f).SetEase(Ease.OutSine));
		this.hackingAniSeq.Insert(0.5f, DOTween.To(() => this.glitchFX2.SettingsTearing.Speed, delegate(float x)
		{
			this.glitchFX2.SettingsTearing.Speed = x;
		}, 5f, 1.5f).SetEase(Ease.OutSine));
		this.hackingAniSeq.Insert(0.5f, DOTween.To(() => this.glitchFX2.SettingsTearing.Intensity, delegate(float x)
		{
			this.glitchFX2.SettingsTearing.Intensity = x;
		}, 0.5f, 1f).SetEase(Ease.OutSine));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX.NoiseIntensity, delegate(float x)
		{
			this.analogFX.NoiseIntensity = x;
		}, 0.98f, 0.4f).SetEase(Ease.Linear));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX.Distortion, delegate(float x)
		{
			this.analogFX.Distortion = x;
		}, 0.2f, 0.4f).SetEase(Ease.OutBack));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX.CubicDistortion, delegate(float x)
		{
			this.analogFX.CubicDistortion = x;
		}, 0.2f, 0.4f).SetEase(Ease.OutBack));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX.Scale, delegate(float x)
		{
			this.analogFX.Scale = x;
		}, 0.8f, 0.4f).SetEase(Ease.OutBack));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX2.NoiseIntensity, delegate(float x)
		{
			this.analogFX2.NoiseIntensity = x;
		}, 0.98f, 0.4f).SetEase(Ease.Linear));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX2.Distortion, delegate(float x)
		{
			this.analogFX2.Distortion = x;
		}, 0.2f, 0.4f).SetEase(Ease.OutBack));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX2.CubicDistortion, delegate(float x)
		{
			this.analogFX2.CubicDistortion = x;
		}, 0.2f, 0.4f).SetEase(Ease.OutBack));
		this.hackingAniSeq.Insert(2f, DOTween.To(() => this.analogFX2.Scale, delegate(float x)
		{
			this.analogFX2.Scale = x;
		}, 0.8f, 0.4f).SetEase(Ease.OutBack));
		this.hackingAniSeq.Insert(2.4f, DOTween.To(() => this.brightFX.Contrast, delegate(float x)
		{
			this.brightFX.Contrast = x;
		}, -100f, 0.4f).SetEase(Ease.Linear));
		this.hackingAniSeq.Insert(2.4f, DOTween.To(() => this.brightFX.Gamma, delegate(float x)
		{
			this.brightFX.Gamma = x;
		}, 9.9f, 0.4f).SetEase(Ease.Linear));
		this.hackingAniSeq.Insert(2.4f, DOTween.To(() => this.brightFX2.Contrast, delegate(float x)
		{
			this.brightFX2.Contrast = x;
		}, -100f, 0.4f).SetEase(Ease.Linear));
		this.hackingAniSeq.Insert(2.4f, DOTween.To(() => this.brightFX2.Gamma, delegate(float x)
		{
			this.brightFX2.Gamma = x;
		}, 9.9f, 0.4f).SetEase(Ease.Linear));
		this.hackingAniSeq.Play<Sequence>();
	}

	public void MaskTheIP()
	{
		this.modemCoolOff = true;
		this.unMaskIPWindowTime = (float)UnityEngine.Random.Range(this.maskIPOpen, this.maskIPClose) * 60f;
	...
	private void startHackAni()
	{
		...
		GameManager.TimeSlinger.FireTimer(1.9f, new Action(this.enableBrightFX));
		GameManager.AudioSlinger.DealSound(AudioHubs.COMPUTER, AudioLayer.HACKINGSFX, this.hackingSFX1, 1f, false);
		this.hackingAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.startHackingLoadingAni));
		this.hackingAniSeq.Insert(0.5f, DOTween.To(() => this.glitchFX.SettingsInterferences.Speed, delegate(float x)
		{
			this.glitchFX.SettingsInterferences.Speed = x;
		}, 6f, 2f).SetEase(Ease.OutSine));
	...
	private void startHackingLoadingAni()
	{
		...
		this.hackingLoadingAniSeq = DOTween.Sequence().OnComplete(new TweenCallback(this.startLoadHackingGame));
		this.hackingLoadingAniSeq.Insert(0f, DOTween.To(() => this.SkullObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.SkullObject.GetComponent<CanvasGroup>().alpha = x;
		}, 1f, 0.5f).SetEase(Ease.OutBack));
		this.hackingLoadingAniSeq.Insert(0f, DOTween.To(() => this.SkullObject.GetComponent<RectTransform>().localScale, delegate(Vector3 x)
		{
			this.SkullObject.GetComponent<RectTransform>().localScale = x;
		}, new Vector3(1f, 1f, 1f), 0.5f).SetEase(Ease.OutBack));
		this.hackingLoadingAniSeq.Insert(1f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, num, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(1.2f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, y, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(1.4f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, num, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(1.6f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, y, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(1.8f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, num, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(2f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, y, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(2.3f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, num - 10f, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(2.9f, DOTween.To(() => this.SkullBottom.GetComponent<RectTransform>().localPosition, delegate(Vector3 x)
		{
			this.SkullBottom.GetComponent<RectTransform>().localPosition = x;
		}, new Vector3(this.SkullBottom.GetComponent<RectTransform>().localPosition.x, y, 0f), 0.2f).SetEase(Ease.Linear));
		this.hackingLoadingAniSeq.Insert(3.5f, DOTween.To(() => this.SkullObject.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
			this.SkullObject.GetComponent<CanvasGroup>().alpha = x;
		}, 0f, 0.5f).SetEase(Ease.InBack));
		this.hackingLoadingAniSeq.Insert(3.5f, DOTween.To(() => this.SkullObject.GetComponent<RectTransform>().localScale, delegate(Vector3 x)
		{
			this.SkullObject.GetComponent<RectTransform>().localScale = x;
		}, new Vector3(1.5f, 1.5f, 1.5f), 0.5f).SetEase(Ease.InBack));
		this.hackingLoadingAniSeq.Play<Sequence>();
	}
	...
	private void buildDOSPuzzle(bool inTutMode = false)
	{
		...
		this.DOSAniSeq.Insert(0.6f, DOTween.To(() => this.DOSPrompt2.fillAmount, delegate(float x)
		{
			this.DOSPrompt2.fillAmount = x;
		}, 1f, 0.2f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(1.4f, DOTween.To(() => this.DOSPrompt3.fillAmount, delegate(float x)
		{
			this.DOSPrompt3.fillAmount = x;
		}, 1f, 0.2f).SetEase(Ease.Linear));
		this.DOSAniSeq.Insert(1.9f, DOTween.To(() => this.DOSNodeHolder.GetComponent<CanvasGroup>().alpha, delegate(float x)
		{
	...
	private void buildKAttack(bool inTutMode = false)
	{
		...
		this.KAniSeq.Insert(0.6f, DOTween.To(() => this.KPrompt2.fillAmount, delegate(float x)
		{
			this.KPrompt2.fillAmount = x;
		}, 1f, 0.2f).SetEase(Ease.Linear));
		this.KAniSeq.Insert(1.4f, DOTween.To(() => this.KPrompt3.fillAmount, delegate(float x)
		{
			this.KPrompt3.fillAmount = x;
		}, 1f, 0.2f).SetEase(Ease.Linear));
		this.KAniSeq.Play<Sequence>();
	...
	private void buildVAttack(bool inTutMode = false)
	{
		...
		this.VAniSeq.Insert(0.6f, DOTween.To(() => this.VPrompt2.fillAmount, delegate(float x)
		{
			this.VPrompt2.fillAmount = x;
		}, 1f, 0.2f).SetEase(Ease.Linear));
		this.VAniSeq.Insert(1.4f, DOTween.To(() => this.VPrompt3.fillAmount, delegate(float x)
		{
			this.VPrompt3.fillAmount = x;
		}, 1f, 0.2f).SetEase(Ease.Linear));
		this.VAniSeq.Play<Sequence>();
	...
	{
		float num = UnityEngine.Random.Range(this.launchHackOpen, this.launchHackClose) * 60f;
